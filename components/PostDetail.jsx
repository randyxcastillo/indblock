    ...
    <>
      <div className="bg-white mt-10">
        <div className="relative overflow-hidden mb-6">
          <img src={post.featuredImage.url} alt="" className="object-top h-full w-full object-cover  shadow-lg rounded-lg lg:rounded-lg" />
        </div>
        <div>
          <div className="flex items-center mb-8 w-full">
            <div className="hidden md:flex items-center justify-center lg:mb-0 lg:w-auto mr-8 items-center">
              ...
              />
              <p className="inline align-middle text-gray-700 ml-2 font-medium text-l">{post.author.name}</p>
            </div>
            <div className="font-medium text-gray-700">
              ...
              <span className="align-middle text-l">{moment(post.datePublished).format('MMM DD, YYYY')}</span>
            </div>
          </div>
          <h1 className="mb-8 text-xl font-semibold">{post.title}</h1>
          <div className="mb-8 text-l font-normal">
